...
export default {
  setup() {
    ...
    const sendMsg = () => {
      ...
      eventSource = new EventSource(`http://localhost:8090/ai/generateStreamAsString?message=${msg.value}`);
      msg.value = '';
    ...
    const getBookings = () => {
      axios.get('http://localhost:8090/booking/list')
          .then((response) => {
            debugger;
